    ...
    <div className="min-h-screen w-full flex flex-col lg:flex-row bg-canvas text-foreground antialiased relative overflow-hidden">
      ...
      <div className="absolute top-4 right-4 z-50">
        <Button
          ...
          className="rounded-full bg-canvas/80 backdrop-blur-md border border-hairline text-steel hover:text-foreground h-8 w-8"
        >
          {theme === 'dark' ? (
      ...
      <div className="w-full lg:w-1/2 min-h-[420px] lg:min-h-screen relative bg-[#0a1530] border-b lg:border-b-0 lg:border-r border-[#1a2a52] flex flex-col justify-center overflow-hidden">
        ...
        <div className="absolute top-6 left-6 z-20 flex items-center gap-2 pointer-events-none">
          <span className="notion-tag notion-tag-mint text-xs font-medium px-2.5 py-1 rounded-full">
            Склад: 89% заполнение
          </span>
          <span className="notion-tag notion-tag-peach text-xs font-medium px-2.5 py-1 rounded-full">
            ТТН #1042 активна
          </span>
        </div>

        <div className="absolute bottom-6 left-6 z-20 flex items-center gap-2 pointer-events-none hidden sm:flex">
          <span className="notion-tag notion-tag-lavender text-xs font-medium px-2.5 py-1 rounded-full">
            Биржевые квоты
          </span>
          <span className="notion-tag notion-tag-sky text-xs font-medium px-2.5 py-1 rounded-full">
            Цементовозы онлайн
          </span>
        </div>
        ...
        <div className="w-full max-w-md space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
          ...
          <div className="space-y-2 text-left">
            <div className="flex items-center gap-2.5">
              {/* Notion N circular logo */}
              <div className="h-9 w-9 rounded-full bg-[#1a1a1a] dark:bg-[#e3e2de] text-white dark:text-[#1a1a1a] flex items-center justify-center font-bold text-base shadow-2xs font-serif shrink-0">
                N
              </div>
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-charcoal dark:text-foreground">
          ...
          {/* Login Card */}
          <Card className="rounded-xl border border-hairline bg-card/90 backdrop-blur-xl shadow-notion-card">
            ...
            <CardContent className="space-y-4 p-5 pt-0">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <div className="absolute left-2.5 top-2.5 h-5 w-5 rounded-full bg-surface border border-hairline flex items-center justify-center text-steel shrink-0">
                    ...
                    <input
                      ...
                      className="flex h-10 w-full rounded-md bg-surface/70 border border-hairline px-3 py-2 text-sm text-foreground placeholder:text-steel focus:outline-none focus:border-primary pl-10 transition-colors"
                    />
                  </div>
                </div>
              ...
              <div className="pt-2">
                <div className="p-3 bg-surface/70 border border-hairline rounded-md flex items-center justify-between text-xs">
                  ...
                  <button
                    ...
                    className="px-3 py-1 text-[11px] font-medium rounded-full bg-tint-lavender text-primary hover:bg-tint-lavender/80 transition-colors"
                  >
                    Заполнить
                  </button>
                </div>
            ...
            <CardFooter className="pt-0 pb-4 justify-center border-t border-hairline mt-2 pt-3">
              <p className="text-[11px] text-steel text-center flex items-center gap-1.5">
                <span className="w-5 h-5 rounded-full bg-tint-mint flex items-center justify-center text-emerald-600 dark:text-emerald-300 shrink-0">
